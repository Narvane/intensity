...
const IDEA_OFFSETS: Record<SuggestionIdeaIndex, ExperienceParameters> = {
  1: { effort: 0, unpredictability: 0, novelty: 0 },
  2: { effort: 1, unpredictability: -1, novelty: 0 },
  3: { effort: -1, unpredictability: 1, novelty: 1 },
};
...
function deriveParameters(
  ...
  return {
    ...
    unpredictability: clampLevel(intensity + offset.unpredictability),
