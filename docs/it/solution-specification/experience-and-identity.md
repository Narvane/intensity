...
**Carta estrazione (modalità Scatola delle Esperienze):** carta a due lati con animazione flip asse Y. Copertina: intensità, parametri, sigillo e un pill del tipo (quando presente) in un angolo. Fronte: descrizione completa e riflessione (autoria nascosta nel rituale).
