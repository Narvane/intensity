...
**Carta de sorteio (modo Caixa de Experiências):** carta de dois lados com animação de virada no eixo Y. Capa: número de intensidade em destaque, parâmetros compactos, selo discreto e pill de tipo (quando houver) num canto. Face: descrição completa e reflexão (autoria oculta no ritual).
