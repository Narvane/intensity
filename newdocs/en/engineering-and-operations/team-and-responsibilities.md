...
| `newdocs/` | Maintainer | Product documentation sync |
...
| Shared | Documentation in `newdocs/`, OpenAPI contract |
...
Canonical product truth: `newdocs/en/`. Onboarding path: Layer 1 → 2 → codebase. Engineering entry: Layer 4 + `api/README` if present.
