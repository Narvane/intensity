...
| `newdocs/` | Maintainer | Sync documentazione prodotto |
...
| Condiviso | Documentazione in `newdocs/`, contratto OpenAPI |
...
Verità prodotto canonica: `newdocs/en/`. Percorso onboarding: Layer 1 → 2 → codebase. Ingresso ingegneria: Layer 4 + `api/README` se presente.
