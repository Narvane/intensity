...
| `newdocs/` | Mantenedor | Sincronização de documentação do produto |
...
| Compartilhado | Documentação em `newdocs/`, contrato OpenAPI |
...
Verdade canônica de produto: `newdocs/en/`. Caminho de onboarding: Camada 1 → 2 → codebase. Entrada de engenharia: Camada 4 + `api/README` se presente.
